...
이번주 실버문제는 기본적인 유형같아서 다시 복습겸 먼저 풀어서 올렸는데 왜 실버 두 개 풀었냐고 논란이 있었던 ㅋㅋㅋㅋ ㅠ
정말 최단경로 찾는 문제 다시 복습할겸 풀었슴니다

> **간단한 설명**

그냥 말그대로 최단경로 찾는 문제라 정말 기본적인 bfs 탐색 로직을 잘 이용해서 깔끔하게 풀렸던 문제!